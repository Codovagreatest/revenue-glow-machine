...
export function Hero({
  ...
  return (
    <section
      ...
      dark:bg-[linear-gradient(to_bottom,hsl(var(--background)),transparent_30%,hsl(var(--primary)/0.1)_78%,hsl(var(--primary)/0.05)_99%_50%)] 
      rounded-b-xl"
    >
      {/* Grid BG */}
      <div
      ...
      <div
        ...
        -translate-x-1/2 rounded-[100%] border-primary/20 bg-background 
        bg-[radial-gradient(closest-side,hsl(var(--background))_82%,hsl(var(--primary)/0.15))] 
        animate-fade-up"
      />
      ...
      {ctaLabel && (
        <div className="flex justify-center">
          <Button
            ...
            variant="hero"
            size="lg"
            className="mt-[-20px] w-fit md:w-52 z-20 font-inter tracking-tighter text-center text-lg"
          >
